...
*/
-- AlterTable
ALTER TABLE "CPEModel" ADD COLUMN "scripts" TEXT;
...
INSERT INTO "new_Contract" ("address", "cep", "contractNumber", "id", "landlordId", "lat", "lng", "name") SELECT "address", "cep", "contractNumber", "id", "landlordId", "lat", "lng", "name" FROM "Contract";
DROP TABLE "Contract";
